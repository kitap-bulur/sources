...
class KitapsecController extends V4Controller {
  ...
  private static function _cache_search($query_url) {
    $cache_name = "Kitapsec_search_" . $query_url;
  ...
  private static function _cache_detail($query_url) {
    $cache_name = "Kitapsec_detail_" . $query_url;
  ...
  private static function _query_detail($query_url) {
    ...
    preg_match_all("'<div class=\"detayBilgiDivIc radius\">\s*<div class=\"baslikText\">ISBN / BARKOD</div>\s*<div class=\"nokta\">:</div>\s*<div class=\"sonucText\" itemprop=\"isbn\">(.*?)</div>'si", $file, $barcode);
    $_barcode = $barcode[1];
