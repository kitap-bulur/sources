...
class IdefixController extends V4Controller {
  ...
  private static function _cache_search($query_url) {
    $cache_name = "Idefix_search_" . $query_url;
  ...
  private static function _cache_detail($query_url) {
    $cache_name = "Idefix_detail_" . $query_url;
  ...
  private static function _query_detail($query_url) {
    ...
    preg_match_all("'<li>\s*<span style=\"width: 25%\">Barkod:</span>\s*<a class=\"bold\">(.*?)</a>\s*</li>'si", $file, $barcode);
    $_barcode = $barcode[1];
